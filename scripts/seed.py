"""
Seed KOCHI2 backend with multi-city cinemas, screens, seats, movies, showtimes.
"""
...
CINEMAS: list[dict] = [
    {"name": "Vanitha Vineetha", "screens": 2},
]
CHAIN_CITY = "Kochi"
...
def seed(db_url: str | None = None) -> None:
    ...
    print(
        f"KOCHI2 seeded: {len(CINEMAS)} cinemas in {CHAIN_CITY}, "
